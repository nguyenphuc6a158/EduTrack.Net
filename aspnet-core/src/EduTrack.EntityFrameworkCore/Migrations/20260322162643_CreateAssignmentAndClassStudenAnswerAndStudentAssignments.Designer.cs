...
namespace EduTrack.Migrations
{
    ...
    [Migration("20260322162643_CreateAssignmentAndClassStudenAnswerAndStudentAssignments")]
    partial class CreateAssignmentAndClassStudenAnswerAndStudentAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTrack.Entities.StudentAnswers.StudentAnswer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("StudentAssignmentId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EduTrack.Entities.StudentAssignments.StudentAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EduTrack.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EduTrack.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EduTrack.Entities.StudentAnswers.StudentAnswer", b =>
                {
                    ...
                    b.HasOne("EduTrack.Entities.QuestionOptions.QuestionOption", "QuestionOption")
                        .WithMany("StudentAnswers")
                        .HasForeignKey("SelectedOptionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EduTrack.Entities.StudentAssignments.StudentAssignment", "StudentAssignment")
                        .WithMany("StudentAnswers")
            ...
            modelBuilder.Entity("EduTrack.Entities.StudentAssignments.StudentAssignment", b =>
                {
                    ...
                    b.HasOne("EduTrack.Authorization.Users.User", "AbpUser")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
