...
public abstract class EduTrackWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static EduTrackWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(EduTrackWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<EduTrackDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<EduTrackDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<EduTrackDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<EduTrackDbContext, Task<T>> func)
    {
        T result;
